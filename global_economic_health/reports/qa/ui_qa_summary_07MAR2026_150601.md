...
- **bubble_map:** reports\qa\screenshots\bubble_map_render_20260307_150552.png

## Test Failures

- **Dashboard file size:** Too small: 0.01 MB
- **dashboard Plotly elements load:** Plotly not found after 5 seconds
...
- [FAIL] Dashboard file size - Too small: 0.01 MB
- [PASS] Dashboard has content
- [PASS] bubble_map Plotly elements load
- [PASS] bubble_map JavaScript errors - No errors in console
- [PASS] bubble_map screenshot captured - Screenshot: bubble_map_render_20260307_150552.png
- [FAIL] dashboard Plotly elements load - Plotly not found after 5 seconds
